    ...
    <section className="py-10 bg-gray-100 sm:py-16 lg:py-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-3xl font-poppins font-bold leading-tight text-black sm:text-4xl lg:text-5xl">
            About E-store
          </h2>
          <p className="max-w-md md:max-w-3xl mx-auto mt-4 text-base leading-relaxed text-gray-500">
            Welcome to E-store, your premier destination for stylish and
            affordable fashion. Founded in 2023, we are dedicated to offering
            the latest trends, exceptional quality, and unmatched customer
            service. We aim to empower our customers with unique and fashionable
            products that reflect their individuality and confidence, all while
